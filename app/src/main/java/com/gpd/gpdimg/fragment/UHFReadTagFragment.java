package com.gpd.gpdimg.fragment;
...
import com.gpd.gpdimg.bin.PreviewBinDetails;
import com.gpd.gpdimg.bin.info.Account;
import com.gpd.gpdimg.tools.StringUtils;
import com.gpd.gpdimg.tools.UIHelper;
    ...
    private void readTag() {
                ...
                mContext.getString(R.string.btInventory)))// 识别标签
        {
            switch (inventoryFlag) {
                case 0:// 单步
                {
                    String strUII = String.valueOf(mContext.mReader.inventorySingleTag());
